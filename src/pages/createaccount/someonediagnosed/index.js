...
export default class SomeoneDiagnosedPage extends Component {
    ...
    onAnswerButtonPress = answer => {
        let { entity } = this.state;
        entity.someoneDiagnosed = answer;
        this.props.navigation.navigate("SomeoneSuspicious", { entity: entity });
    };
};

const IntroText = () => (
    <View style={styles.textContainer}>
        <Text style={[styles.simpleText]}>Você teve contato com <Text style={styles.boldText}>alguém</Text></Text>
        <Text style={[styles.simpleText]}><Text style={styles.boldText}>diagnosticado</Text> com Coronavírus</Text>
        <Text style={[styles.simpleText]}>nos últimos 14 dias?</Text>
    </View>
);
