              ...
              <CustomHiddenView show={entity.hasSymptons}>
                ...
                <View style={styles.oximeterContainer}>
                  ...
                  <View style={styles.oximeterContainerRadioBtn}>
                    <RadioButtonYesOrNoItem
                      value={entity.hasOximeter}
                      onPressCheckbox={this.onPressCheckBoxOximeter}
                    />
                  </View>
                </View>
                <CustomHiddenView show={entity.hasOximeter}>
                  <View style={styles.oximeterContainer}>
                    ...
                    <View style={styles.oximeterContainerRadioBtn}>
                      <RadioButtonYesOrNoItem
                        value={entity.hasSaturation}
                        onPressCheckbox={this.onPressCheckBoxSaturation}
                      />
                    </View>
                  </View>
                </CustomHiddenView>
